...
def handler(event, context):
    ...
    ticket_request: str = f"""
     I want you to translate the following text into Bulgarian . Structure the answer by JSON format - keys by fields {ticket_fields} and values by actual translation .
     - Title : {title}
