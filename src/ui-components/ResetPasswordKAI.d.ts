...
export declare type ResetPasswordKAIOverridesProps = {
    ResetPasswordKAI?: PrimitiveOverrideProps<ViewProps>;
...
export declare type ResetPasswordKAIProps = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: ResetPasswordKAIOverridesProps | undefined | null;
}>;
export default function ResetPasswordKAI(props: ResetPasswordKAIProps): React.ReactElement;
