...
export declare type BoardPageOverridesProps = {
    BoardPage?: PrimitiveOverrideProps<ViewProps>;
...
export declare type BoardPageProps = React.PropsWithChildren<Partial<ViewProps> & {
    user?: User;
} & {
    overrides?: BoardPageOverridesProps | undefined | null;
}>;
export default function BoardPage(props: BoardPageProps): React.ReactElement;
