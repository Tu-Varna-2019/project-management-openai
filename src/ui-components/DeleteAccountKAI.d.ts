...
export declare type DeleteAccountKAIOverridesProps = {
    DeleteAccountKAI?: PrimitiveOverrideProps<ViewProps>;
...
export declare type DeleteAccountKAIProps = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: DeleteAccountKAIOverridesProps | undefined | null;
}>;
export default function DeleteAccountKAI(props: DeleteAccountKAIProps): React.ReactElement;
