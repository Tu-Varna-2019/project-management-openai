...
export default function TicketCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setStoryPoint(initialValues.StoryPoint);
    setWatch(initialValues.Watch);
    setReporter(initialValues.Reporter);
    setAsignee(initialValues.Asignee);
    setImageTicket(initialValues.ImageTicket);
    setEpicLink(initialValues.EpicLink);
    setCreatedDate(initialValues.CreatedDate);
    setUpdatedDate(initialValues.UpdatedDate);
    setResolvedDate(initialValues.ResolvedDate);
    ...
    setTicketStatus(initialValues.TicketStatus);
    setErrors({});
  };
