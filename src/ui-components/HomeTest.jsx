    ...
    >
      ...
      >
        <Divider
          ...
          {...getOverrideProps(overrides, "Divider176731632")}
        ></Divider>
        <Divider
          width="1346px"
          height="16px"
          ...
          size="small"
          orientation="horizontal"
          {...getOverrideProps(overrides, "Divider176731633")}
        ></Divider>
        <View
          width="1346px"
          height="171px"
        ...
        >
          <Text
            ...
            whiteSpace="pre-wrap"
            children="Created by "
            {...getOverrideProps(overrides, "powered_by_amplify_text176731636")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="16px"
            ...
            {...getOverrideProps(overrides, "powered_by_amplify_text176731637")}
          ></Text>
        </View>
        <SearchField
          width="622px"
        ...
        <Divider
          ...
          size="small"
          orientation="horizontal"
          {...getOverrideProps(overrides, "Divider176731650")}
        ></Divider>
        <Badge
          width="898px"
          height="unset"
          ...
          >
            ...
            >
              <Icon
                ...
                left="0%"
                right="0%"
                {...getOverrideProps(overrides, "Vector176731656")}
              ></Icon>
            </View>
            <View
              padding="0px 0px 0px 0px"
            ...
            >
              <Icon
                ...
                left="0%"
                right="42.17%"
                {...getOverrideProps(overrides, "Vector176731658")}
              ></Icon>
              <Icon
                width="16.64px"
                height="23.02px"
                ...
                left="32.53%"
                right="21.69%"
                {...getOverrideProps(overrides, "Vector176731659")}
              ></Icon>
              <Icon
                width="21.02px"
                height="25px"
                ...
                left="42.17%"
                right="0%"
                {...getOverrideProps(overrides, "Vector176731660")}
              ></Icon>
            </View>
          </Flex>
        </Flex>
